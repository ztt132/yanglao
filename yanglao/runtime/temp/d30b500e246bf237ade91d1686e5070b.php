<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"/Users/cesc/365web/yanglao/yanglao/public/../application/admin/view/activity/index.html";i:1593321451;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card padding20">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加活动','/admin/activity/add',700,700)"><i class="layui-icon"></i>添加</button>
                </div>

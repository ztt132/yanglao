<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"/database/webroot/yanglao/public/../application/admin/view/city/add.html";i:1593570836;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="layui-input-inline">
            <select name="pinyin" lay-verify="pinyin" lay-search="">
                ...
                <?php if(is_array($citys) || $citys instanceof \think\Collection || $citys instanceof \think\Paginator): if( count($citys)==0 ) : echo "" ;else: foreach($citys as $key=>$city): ?>
                    <option value="<?php echo $city['city_key']; ?>"><?php echo $city['city_name']; ?></option>

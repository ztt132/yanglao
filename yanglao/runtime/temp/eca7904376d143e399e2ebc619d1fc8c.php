<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"/database/webroot/yanglao/public/../application/admin/view/org/add.html";i:1599125012;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block margin-right">
            ...
            <input type="checkbox" title="<?php echo $item; ?>" value="<?php echo $key; ?>" lay-filter="target_person">
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="z-index:0">
            <div class="editor">
                <p><?php echo $config['comment']; ?></p></div>
        </div>
    </div>
    <div class="layui-form-item" pane="">
        ...
        <div class="layui-input-block">
            ...
            <input type="checkbox" title="<?php echo $e['name']; ?>" lay-filter="equipment" value="<?php echo $e['id']; ?>">
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
    </div>
    ...
    <div class="layui-form-item" pane="" id="serviceParent">
        ...
        <?php if(is_array($config['service']) || $config['service'] instanceof \think\Collection || $config['service'] instanceof \think\Paginator): if( count($config['service'])==0 ) : echo "" ;else: foreach($config['service'] as $key=>$item): ?>
        <div class="layui-input-block margin-right service_margin_top">
            <input type="text" placeholder="服务" value="<?php echo $item['name']; ?>" class="layui-input service_name">
            <input type="text" placeholder="详细介绍" value="<?php echo $item['desc']; ?>" class="layui-input service_desc service_name_desc_margin">

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/database/webroot/yanglao/public/../application/admin/view/estatephoto/edit.html";i:1610429341;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block margin-right">
            <select name="org_id" lay-filter="org_id" id="org_id" lay-verify="org_id" lay-search="">
                ...
                <option value="<?php echo $item['id']; ?>" <?php if($item['id'] == $photo['estate_id']): ?>selected<?php endif; ?>><?php echo $item['name']; ?></option>

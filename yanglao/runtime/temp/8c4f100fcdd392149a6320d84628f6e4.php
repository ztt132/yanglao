<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"/Users/cesc/365web/yanglao/yanglao/public/../application/admin/view/district/index.html";i:1593399491;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card padding20">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加区域','/admin/district/add',600,400)"><i class="layui-icon"></i>添加</button>
                </div>
...
<script>
    layui.use(['table','form'], function(){
        ...
        var districtTable = table.render({
            elem: '#list',
            url: '/admin/district/districtList', //数据接口
            page: true, //开启分页
            method:'get',
            ...
            cols: [[
                ...
                {field: 'city_name', title: '城市名称', align:'center', sort: false, fixed: 'left'},
                {field: 'name', title: '区域', align:'center', sort: false, fixed: 'left'},
    ...
    function edit(obj) {
        ...
        layui.use('layer',function(){
            ...
            layer.open({
                ...
                type:2,
                area: ['50%', '65%'],
                content:'/admin/district/edit?id='+id
            })
        })
    }
</script>

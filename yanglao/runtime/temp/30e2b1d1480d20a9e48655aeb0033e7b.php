<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/Users/cesc/365web/yanglao/yanglao/public/../application/admin/view/role/index.html";i:1593329861;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card padding20">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加角色','/admin/role/add',600,500)"><i class="layui-icon"></i>添加</button>
                </div>
    ...
    layui.use(['table','form'], function(){
        ...
        var cityTable = table.render({
            ...
            cols: [[
                ...
                {field: 'name', title: '权限名称', align:'center', sort: false, fixed: 'left'},
    ...
    function edit($this) {
        ...
        layui.use('layer',function(){
            ...
            layer.open({
                ...
                type:2,
                area: ['50%', '60%'],
                content:'/admin/role/edit?id='+id //url
            })
        })
    }

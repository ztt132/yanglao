<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/database/webroot/yanglao/public/../application/admin/view/account/index.html";i:1594000256;}*/ ?>
<!DOCTYPE html>
    ...
    layui.use(['table','form'], function(){
        ...
        var cityTable = table.render({
            ...
            cols: [[
                ...
                {field: '修改密码', title: '修改密码',align:'center',  templet: '#operationPwd', fixed: 'left'}
            ]]
        });
    ...
    function editPwd($this) {
        ...
        layui.use('layer',function(){
            ...
            layer.open({
                ...
                type:2,
                area: ['50%', '60%'],
                content:'/admin/account/editPwd?id='+id //url
            })
        })
    }
...
<script type="text/html" id="operationPwd">
    <a val="{{d.id}}" onclick="editPwd(this)" class="edit layui-table-link">编辑</a>
</script>
</html>
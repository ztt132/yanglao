<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/Users/cesc/365web/yanglao/yanglao/public/../application/admin/view/hx/edit.html";i:1592980415;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block margin-right">
            <select name="org_id" lay-filter="org_id" id="org_id" lay-verify="org_id">
                ...
                <option value="<?php echo $item['id']; ?>" <?php if($item['id'] == $hx['org_id']): ?>selected<?php endif; ?>><?php echo $item['name']; ?></option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block margin-right">
            <input type="text" name="name" lay-verify="name" placeholder="请输入户型名称" value="<?php echo $hx['name']; ?>" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-upload-list">
            <input type="hidden" id="cover_pic" value="<?php echo $hx['cover_pic']; ?>" lay-verify="cover_pic" name="cover_pic">
            <img class="pic_preview" id="pic_preview" src="<?php echo $hx['cover_pic']; ?>">
            <p id="pic_text"></p>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block margin-right">
            <input type="text" name="vr" lay-verify="vr" value="<?php echo $hx['vr']; ?>" placeholder="请输入vr地址" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">

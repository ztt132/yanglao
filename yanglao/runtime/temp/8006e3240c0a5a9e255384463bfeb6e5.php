<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"/database/webroot/yanglao/public/../application/admin/view/community/index.html";i:1605075601;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="layui-card padding20">
                <div class="layui-card-body ">
                    <form class="layui-form layui-col-space5">
                        ...
                        <div class="layui-inline layui-show-xs-block">
                            <input type="text" name="district_name"  placeholder="请输入区域名" value="<?php if($district_name): ?><?php echo $district_name; endif; ?>" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-inline layui-show-xs-block">
                            <input type="text" name="street_name"  placeholder="请输入街道名" value="<?php if($street_name): ?><?php echo $street_name; endif; ?>" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-inline layui-show-xs-block">
                            <input type="text" name="name"  placeholder="请输入社区名" value="<?php if($name): ?><?php echo $name; endif; ?>" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-inline layui-show-xs-block">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加社区','/admin/community/add',600,400)"><i class="layui-icon"></i>添加</button>
                </div>
...
<script>
    layui.use(['table','form'], function(){
        ...
        var districtTable = table.render({
            elem: '#list',
            url: '/admin/community/communityList', //数据接口
            page: true, //开启分页
            method:'get',
            ...
            cols: [[
                ...
                {field: 'street_name', title: '街道', align:'center', sort: false, fixed: 'left'},
                {field: 'name', title: '社区', align:'center', sort: false, fixed: 'left'},
    ...
    function edit(obj) {
        ...
        layui.use('layer',function(){
            ...
            layer.open({
                ...
                type:2,
                area: ['50%', '65%'],
                content:'/admin/community/edit?id='+id
            })
        })
    }
</script>

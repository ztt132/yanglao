<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/database/webroot/yanglao/public/../application/admin/view/estate/add.html";i:1610535599;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="layui-tab-item layui-show">
                ...
                <?php if(is_array($form['basic']) || $form['basic'] instanceof \think\Collection || $form['basic'] instanceof \think\Paginator): if( count($form['basic'])==0 ) : echo "" ;else: foreach($form['basic'] as $key=>$item): if($item['type'] == 'text'): ?>
                        <div class="layui-form-item layui-form-text">
                            ...
                            <div class="layui-input-block margin-right">
                                <input type="text" id="<?php echo $item['key']; ?>" name="<?php echo $item['key']; ?>" lay-verify="<?php echo $item['key']; ?>" class="layui-input">
                            </div>
                        </div>
                    <?php else: ?>
                        <div class="layui-form-item">
            ...
            <div class="layui-tab-item">
                ...
                <div class="layui-form-item" pane="">
                    ...
                    <div class="layui-input-block margin-right">
                        ...
                        <input type="text" placeholder="请输入号码" id="phone" name="phone" class="layui-input org_tag org_tag_margin_left">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block margin-right">
                        <textarea placeholder="请输入内容" class="layui-textarea" name="cost_type" id="cost_type" lay-filter="cost_type" lay-verify="cost_type"></textarea>
                    </div>
                </div>
...
<script>
    ...
    layui.use(['form','laydate','jquery','slider','upload','element'], function(){
        ...
        form.on('submit(submit)', function(formData){
            ...
            submit('/admin/estate/create',data);
            return false;
        })

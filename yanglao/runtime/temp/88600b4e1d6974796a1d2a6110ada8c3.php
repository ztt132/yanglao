<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/Users/cesc/365web/yanglao/yanglao/public/../application/admin/view/news/index.html";i:1593320301;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card padding20">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加咨询','/admin/news/add',700,700)"><i class="layui-icon"></i>添加</button>
                </div>
    ...
    layui.use(['table','form'], function(){
        ...
        var districtTable = table.render({
            ...
            cols: [[
                ...
                {field: 'user_name', title: '发布人', align:'center', sort:false, fixed: 'left'},

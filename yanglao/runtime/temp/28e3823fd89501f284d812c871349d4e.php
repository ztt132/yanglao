<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"/Users/cesc/365web/yanglao/yanglao/public/../application/admin/view/equipment/index.html";i:1593415514;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card padding20">
                <div class="layui-card-body">
                    <form class="layui-form layui-col-space5">
                        <div class="layui-inline layui-show-xs-block">
                            <input type="text" name="name"  placeholder="请输入名称" value="<?php if($name): ?><?php echo $name; endif; ?>" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-inline layui-show-xs-block">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加设备','/admin/equipment/add',700,700)"><i class="layui-icon"></i>添加</button>
                </div>
...
<script>
    layui.use(['table','form'], function(){
        ...
        var districtTable = table.render({
            elem: '#list',
            url: '/admin/equipment/equipmentList', //数据接口
            page: true, //开启分页
            method:'get',
            ...
            cols: [[
                ...
                {field: 'pic', title: '图标', align:'center', templet:'#img', fixed: 'left'},
                {field: 'sort', title: '排序',align:'center',  sort: false, fixed: 'left'},
    ...
    function edit(obj) {
        ...
        layui.use('layer',function(){
            ...
            layer.open({
                ...
                type:2,
                area: ['50%', '80%'],
                content:'/admin/equipment/edit?id='+id
            })
        })
    }
</script>

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"/Users/cesc/365web/yanglao/yanglao/public/../application/admin/view/banner/edit.html";i:1593410149;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block margin-right">
            <input type="text" name="link_url" lay-verify="link_url" value="<?php echo $banner['link_url']; ?>" placeholder="请输入跳转地址" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">截止时间</label>
        <div class="layui-input-inline">
            <input type="text" name="deadline" id="deadline" lay-verify="deadline" autocomplete="on" class="layui-input" value="<?php echo $banner['deadline']; ?>" placeholder="请选择截止时间">
        </div>
    </div>
    <div class="layui-form-item">

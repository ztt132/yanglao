<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/database/webroot/yanglao/public/../application/admin/view/estatenews/index.html";i:1610429341;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card padding20">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加资讯','/admin/estatenews/add',700,500)"><i class="layui-icon"></i>添加</button>
                </div>
...
<script>
    layui.use(['table','form'], function(){
        ...
        var districtTable = table.render({
            elem: '#list',
            url: '/admin/estatenews/newsList', //数据接口
            page: true, //开启分页
            method:'get',
            ...
            cols: [[
                ...
                {field: 'name', title: '楼盘',align:'center',  sort: false, fixed: 'left'},
                {field: 'publish_time', title: '发布时间',align:'center',  sort: false, fixed: 'left'},
                {field: 'content', title: '内容',align:'center',  sort: false, fixed: 'left'},
    ...
    function edit(obj) {
        ...
        layui.use('layer',function(){
            ...
            layer.open({
                ...
                type:2,
                area: ['60%', '80%'],
                content:'/admin/estatenews/edit?id='+id
            })
        })
    }
</script>

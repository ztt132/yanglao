<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/database/webroot/yanglao/public/../application/admin/view/news/edit.html";i:1604023419;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block margin-right">
            <input type="text" value="<?php echo $news['publisher']; ?>" name="publisher" lay-verify="publisher" placeholder="请输入发布人" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-upload-list">
            <input type="hidden" id="pic" lay-verify="pic" name="pic" value="<?php echo $news['pic']; ?>">
            <img class="pic_preview" id="pic_preview" src="<?php echo $news['pic']; ?>">
            <p id="pic_text"></p>
        </div>
    </div>
    <div class="layui-form-item">

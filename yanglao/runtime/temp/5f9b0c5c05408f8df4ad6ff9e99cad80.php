<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"/Users/cesc/365web/yanglao/yanglao/public/../application/admin/view/banner/index.html";i:1593309254;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card padding20">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加banner','/admin/banner/add',600,700)"><i class="layui-icon"></i>添加</button>
                </div>

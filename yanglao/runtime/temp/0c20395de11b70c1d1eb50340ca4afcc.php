<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"/database/webroot/yanglao/public/../application/admin/view/estatenews/edit.html";i:1610521376;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block margin-right">
            <select name="estate_id" lay-filter="estate_id" id="estate_id" lay-verify="estate_id" lay-search="">
                ...
                <option value="<?php echo $estate['id']; ?>" <?php if($news['estate_id'] == $estate['id']): ?>selected<?php endif; ?>><?php echo $estate['name']; ?></option>
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-inline">
            <input value="<?php echo $news['publish_time']; ?>" readonly type="text" name="publish_time" id="publish_time" lay-verify="publish_time" autocomplete="on" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label"><span class="require">*</span>内容</label>
        <div class="layui-input-block margin-right" style="z-index:0">
            <textarea placeholder="请输入内容" class="layui-textarea" name="content" id="content" lay-filter="content" lay-verify="content"><?php echo $news['content']; ?></textarea>
        </div>
    </div>
    <div class="layui-form-item">

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"/database/webroot/yanglao/public/../application/admin/view/introduce/index.html";i:1593569117;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card padding20">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加介绍','/admin/introduce/add',700,500)"><i class="layui-icon"></i>添加</button>
                </div>

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/database/webroot/yanglao/public/../application/admin/view/equipment/add.html";i:1597131365;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" action="">
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block margin-right">
            <input type="text" name="name" lay-verify="name" placeholder="请输入名称" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label"><span class="require">*</span>排序</label>
        <div class="layui-input-block margin-right">
            <input type="text" name="sort" lay-verify="sort" placeholder="请输入排序" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label"><span class="require">*</span>图片</label>
        <button type="button" class="layui-btn" id="upload_btn">上传</button>图片尺寸72*43

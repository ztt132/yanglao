<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/database/webroot/yanglao/public/../application/admin/view/estatephoto/index.html";i:1610429341;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card padding20">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加相册','/admin/estatephoto/add',600,700)"><i class="layui-icon"></i>添加</button>
                </div>
...
<script>
    layui.use(['table','form'], function(){
        ...
        var districtTable = table.render({
            elem: '#list',
            url: '/admin/estatephoto/photoList', //数据接口
            page: true, //开启分页
            method:'get',
        ...
        form.on('switch(is_cover)',function (obj){
            ...
            var id = s.attr('val');
            $.ajax({
                url:'/admin/estatephoto/changeCover',
                dataType:'json',
                type:'post',
                data:{
                    id:id
    ...
    function edit(obj) {
        ...
        layui.use('layer',function(){
            ...
            layer.open({
                ...
                type:2,
                area: ['50%', '80%'],
                content:'/admin/estatephoto/edit?id='+id
            })
        })
    }
</script>

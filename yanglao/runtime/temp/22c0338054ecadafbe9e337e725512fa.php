<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/database/webroot/yanglao/public/../application/admin/view/feedback/index.html";i:1597211928;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="layui-card-body">
                    <form class="layui-form layui-col-space5">
                        <div class="layui-inline layui-show-xs-block">
                            <input type="text" name="phone"  placeholder="请输入手机号" value="<?php if($phone): ?><?php echo $phone; endif; ?>" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-inline layui-show-xs-block">
...
<script>
    layui.use(['table','form'], function(){
        ...
        var cityTable = table.render({
            elem: '#list',
            url: '/admin/feedback/feedbackList', //数据接口
            page: true, //开启分页
            method:'get',
            ...
            cols: [[
                ...
                {field: 'content', title: '反馈内容', align:'center', sort: false, fixed: 'left'},
                {field: 'phone', title: '手机', align:'center', sort: false, fixed: 'left'},
            ]]
        });

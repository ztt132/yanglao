<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/database/webroot/yanglao/public/../application/admin/view/activity/edit.html";i:1595834780;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="z-index:0">
            <div class="editor"><?php echo $activity["content"]; ?></div>
        </div>
    </div>
    <div class="layui-form-item">

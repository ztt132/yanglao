<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/Users/cesc/365web/yanglao/yanglao/public/../application/admin/view/city/edit.html";i:1593396847;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="pinyin" lay-verify="pinyin" lay-search="">
                ...
                <option value="<?php echo $item['city_pinyin']; ?>" <?php if($item['city_pinyin'] == $city['pinyin']): ?>selected<?php endif; ?>><?php echo $item['city_name']; ?></option>

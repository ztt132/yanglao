<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"/Users/cesc/365web/yanglao/yanglao/public/../application/admin/view/introduce/index.html";i:1593412345;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card padding20">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加介绍','/admin/introduce/add',700,700)"><i class="layui-icon"></i>添加</button>
                </div>
...
<script>
    layui.use(['table','form'], function(){
        ...
        var districtTable = table.render({
            elem: '#list',
            url: '/admin/introduce/introduceList', //数据接口
            page: true, //开启分页
            method:'get',
            ...
            cols: [[
                ...
                {field: 'dean_name', title: '院长姓名',align:'center',  sort: false, fixed: 'left'},
    ...
    function edit(obj) {
        ...
        layui.use('layer',function(){
            ...
            layer.open({
                ...
                type:2,
                area: ['50%', '80%'],
                content:'/admin/introduce/edit?id='+id
            })
        })
    }
</script>

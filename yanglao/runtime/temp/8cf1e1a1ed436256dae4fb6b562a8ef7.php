<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/database/webroot/yanglao/public/../application/admin/view/qrcode/add.html";i:1598427654;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block margin-right">
            <input type="text" name="name" lay-verify="name" placeholder="请输入二维码名称" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block margin-right">
            <input type="text" name="obj_id" lay-verify="obj_id" placeholder="请输入对象id" class="layui-input">
        </div>
    </div>

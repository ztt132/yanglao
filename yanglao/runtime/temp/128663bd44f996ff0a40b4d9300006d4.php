<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/Users/cesc/365web/yanglao/yanglao/public/../application/admin/view/hx/index.html";i:1592980505;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card padding20">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加户型','/admin/hx/add',600,700)"><i class="layui-icon"></i>添加</button>
                </div>
    ...
    layui.use(['table','form'], function(){
        ...
        var districtTable = table.render({
            ...
            cols: [[
                ...
                {field: 'cover_pic', title: '图片', align:'center', templet:'#img', fixed: 'left'},

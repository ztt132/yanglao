<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/Users/cesc/365web/yanglao/yanglao/public/../application/admin/view/role/add.html";i:1593328570;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block margin-right">
            <input type="text" name="name" lay-verify="name" placeholder="请输入角色名" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <?php if(is_array($menu) || $menu instanceof \think\Collection || $menu instanceof \think\Paginator): if( count($menu)==0 ) : echo "" ;else: foreach($menu as $key=>$item): ?>
                ...
                <?php if(is_array($item['sub_menu']) || $item['sub_menu'] instanceof \think\Collection || $item['sub_menu'] instanceof \think\Paginator): if( count($item['sub_menu'])==0 ) : echo "" ;else: foreach($item['sub_menu'] as $key=>$subMenu): ?>

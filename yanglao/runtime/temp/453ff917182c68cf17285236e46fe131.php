<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"/database/webroot/yanglao/public/../application/admin/view/estate/index.html";i:1610429341;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="layui-card-body ">
                    <form class="layui-form layui-col-space5">
                        <div class="layui-inline layui-show-xs-block">
                            <input type="text" name="name"  placeholder="请输入养老地产名称" value="<?php if($name): ?><?php echo $name; endif; ?>" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-inline layui-show-xs-block">
...
<script>
    layui.use(['table','form'], function(){
        ...
        var orgTable = table.render({
            elem: '#list',
            url: '/admin/estate/estateList', //数据接口
            page: true, //开启分页
            method:'get',
        ...
        form.on('submit(is_delete)',function (obj) {
            var s = $(obj.elem);
            var id = s.val();
            layer.confirm('确定要删除此养老地产？', {
                btn: ['确定','取消'] //按钮
            }, function(){
                $.ajax({
                    url:'/admin/estate/delete',
                    dataType:'json',
                    type:'post',
                    data:{
                        id:id
    ...
    function edit(obj) {
        ...
        layui.use('layer',function(){
            ...
            layer.open({
                ...
                type:2,
                area: ['60%', '80%'],
                content:'/admin/estate/edit?id='+id
            })
        })
    }

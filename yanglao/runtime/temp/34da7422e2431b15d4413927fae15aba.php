<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/database/webroot/yanglao/public/../application/admin/view/banner/add.html";i:1595324132;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block margin-right">
            <input type="text" name="link_url" lay-verify="link_url" placeholder="H5链接/养老机构ID/资讯ID" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label"><span class="require">*</span>截止时间</label>
        <div class="layui-input-inline">
            <input readonly type="text" name="deadline" id="deadline" lay-verify="deadline" autocomplete="on" class="layui-input" placeholder="请选择截止时间">
        </div>
    </div>
    <div class="layui-form-item">

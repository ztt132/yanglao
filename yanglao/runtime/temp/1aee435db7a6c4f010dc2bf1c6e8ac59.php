<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/database/webroot/yanglao/public/../application/admin/view/introduce/edit.html";i:1595322095;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" action="">
    <input type="hidden" value="<?php echo $introduce['id']; ?>" name="id">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block margin-right">
            <select name="org_id" lay-filter="org_id" id="org_id" lay-verify="org_id">
                ...
                <option value="<?php echo $item['id']; ?>" <?php if($item['id'] == $introduce['org_id']): ?>selected<?php endif; ?>><?php echo $item['name']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label"><span class="require">*</span>院长姓名</label>
        <div class="layui-input-block margin-right">
            <input value="<?php echo $introduce['dean_name']; ?>" type="text" name="dean_name" lay-verify="dean_name" placeholder="请输入院长姓名" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label"><span class="require">*</span>院长介绍</label>
        <div class="layui-input-block margin-right">
            <input value="<?php echo $introduce['dean_desc']; ?>" type="text" name="dean_desc" lay-verify="dean_desc" placeholder="请输入院长介绍" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label"><span class="require">*</span>头像</label>
        <button type="button" class="layui-btn" id="upload_btn">上传</button>
        <div class="layui-upload-list">
            <input type="hidden" id="pic" lay-verify="pic" name="pic" value="<?php echo $introduce['pic']; ?>">
            <img class="pic_preview" id="pic_preview" src="<?php echo $introduce['pic']; ?>">
            <p id="pic_text"></p>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="z-index:0">
            <div class="editor"><?php echo $introduce["content"]; ?></div>
        </div>
    </div>

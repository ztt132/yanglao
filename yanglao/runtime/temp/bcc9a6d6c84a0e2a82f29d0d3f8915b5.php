<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/database/webroot/yanglao/public/../application/admin/view/streetupload/index.html";i:1605148462;}*/ ?>
<!DOCTYPE html>
...
<script>
    ...
    layui.use(['upload','form'], function(){
        ...
        upload.render({
            elem: '#upload',
            url: '/admin/streetupload/upload',//改成您自己的上传接口,
            accept: 'file', //普通文件
            exts:'xlsx',
            before:function() {
